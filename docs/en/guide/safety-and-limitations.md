...
EMI Guardian provides engineering screening and workflow assistance. Its results are not proof that no physical EMI source exists and do not establish EMC compliance or manufacturing acceptance.
...
- Automated tests do not include a live KiCad GUI, physical EMC, or manufacturer acceptance; execute the [live acceptance test](../development/acceptance-test.md).
