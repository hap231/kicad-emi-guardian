...
Each finding carries a category, severity, confidence, and penalty. Diminishing category impact replaces an unbounded linear sum. Repeated low-priority findings therefore do not pin a category to exactly zero; the score floor is 1.0.
