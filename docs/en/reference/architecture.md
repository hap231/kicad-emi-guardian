...
The server uses loopback, an ephemeral port, a random token, request limits, and CSP. Idle shutdown is configurable but disabled by default. Browser heartbeat drives KiCad ping and bounded reconnect.
