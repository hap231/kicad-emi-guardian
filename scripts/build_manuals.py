...
MANUALS = (
    {
        "language": "ja",
        "title": "EMI Guardian 0.0.2 取扱説明書",
        "source": ROOT / "docs" / "ja" / "user-manual.md",
        "html_name": "EMI-Guardian-User-Manual-JA.html",
        "markdown_name": "EMI-Guardian-User-Manual-JA.md",
    },
    {
        "language": "en",
        "title": "EMI Guardian 0.0.2 User Manual",
        "source": ROOT / "docs" / "en" / "user-manual.md",
...
.version {{ color:var(--muted); font-size:.88rem; margin-bottom:18px; }}
...
{body}
<footer>EMI Guardian {VERSION} · Pre-release engineering preview · Generated from the bilingual source documentation.</footer>
</main>
</div>
</body>
</html>
...
def build_manual_files(output_directory: Path) -> dict[str, Path]:
    ...
    readme.write_text(
        "EMI Guardian 0.0.2 user manuals\n"
        "================================\n\n"
